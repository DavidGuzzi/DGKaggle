...
> Unless specified otherwise, all references to yuan in this section denote Chinese yuan (CNY).

> Tip: Expand a dataset name below to view its column dictionary.

## Dataset Groups
- [Pre-owned Housing Activity](#pre-owned-housing-activity)
- [Land Market Activity](#land-market-activity)
- [New Housing Supply and Demand](#new-housing-supply-and-demand)
- [Sector-level Points of Interest](#sector-level-points-of-interest)
- [City-level Signals](#city-level-signals)

## Pre-owned Housing Activity

Transactional metrics for pre-owned properties measured within each sector and across nearby sectors.

<details>
<summary><code>train/pre_owned_house_transactions.csv</code> - 6 columns</summary>
...
<details>
<summary><code>train/pre_owned_house_transactions_nearby_sectors.csv</code> - 6 columns</summary>
...
Land transaction volumes, areas, and valuations reported locally and aggregated across neighboring sectors.

<details>
<summary><code>train/land_transactions.csv</code> - 6 columns</summary>
...
<details>
<summary><code>train/land_transactions_nearby_sectors.csv</code> - 6 columns</summary>
...
New construction sales, inventory, and pricing signals for each sector and its vicinity.

<details>
<summary><code>train/new_house_transactions.csv</code> - 11 columns</summary>
...
<details>
<summary><code>train/new_house_transactions_nearby_sectors.csv</code> - 11 columns</summary>
...
## Sector-level Points of Interest

Structural, demographic, and amenities data that characterize each geographic sector.

<details>
<summary><code>train/sector_POI.csv</code> - 142 columns</summary>
...
Macro-level search trends and city indices that complement sector granularity.

<details>
<summary><code>train/city_search_index.csv</code> - 4 columns</summary>
...
<details>
<summary><code>train/city_indexes.csv</code> - 74 columns</summary>
